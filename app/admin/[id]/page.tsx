    ...
    useEffect(() => {
        ...
        const fetchArticle = async () => {
            try {
                ...
                const art = data.data as Article
                ...
                setCoverImagePosition(art.cover_image_position || '50% 50%')
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6 space-y-4 sticky top-20">
                            ...
                            {article && (
                                <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                                    <h4 className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-2">Stats</h4>
                                    <div className="grid grid-cols-2 gap-2 text-sm">
                                        <div className="text-gray-600 dark:text-gray-400">Views:</div>
                                        <div className="text-gray-900 dark:text-white">{article.view_count.toLocaleString()}</div>
                                        <div className="text-gray-600 dark:text-gray-400">Reading time:</div>
                                        <div className="text-gray-900 dark:text-white">{article.reading_time} min</div>
                                        <div className="text-gray-600 dark:text-gray-400">Created:</div>
                                        <div className="text-gray-900 dark:text-white">{new Date(article.created_at).toLocaleDateString()}</div>
                                    </div>
                                </div>
                            )}
                        </div>
